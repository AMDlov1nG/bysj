...
5.查看今日商店皮肤及预览/n
6.武器数据查询/n
7.武器皮肤数据趣味分析+推荐（无机器学习 洗牌算法）/n

=====问题===== /n
1.默认给予测试账号，且每次重启APP不记录上次键入账号/n
2.武器数据页面排版有误/n
3.数据分析+推荐系统使用数据库，但我并未编写自动更新数据库的代码，数据将维持在4月16日前的皮肤数据（直到我编写或更新数据库）/n
4.API数据对比使用使用了字典，代码较为混乱，懒得修改了，会导致部分皮肤无预览图/视频/n
